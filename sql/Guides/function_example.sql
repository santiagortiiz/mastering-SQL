-- Diferencias STORE PROCEDURE y FUNCTIONS.
-- STORE PROCEDURE: no regresan valor y hacen parte del estándar SQL
-- FUNCTIONS: regresan valores, son mas flexibles y son propias de PostgreSQL/PLPGSQL
